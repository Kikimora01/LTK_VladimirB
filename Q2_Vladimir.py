...
# The program using OOP was taken as the starting point.
# However, there are many fundamental errors in the listing.
# In addition, this approach does not result in AND answers and cannot read negative numbers.
# I rewrote the program and debugged it.
# https://www.tutorialspoint.com/integer-to-english-words-in-python-programming

# Rules for English reading integers can be found here:
