import unittest
################ 444444444444444444
# Question 2: write a function that takes an integer between negative one billion and
...
print(ob.numberToWords(n6))
print(ob.numberToWords(n7))
print(ob.numberToWords(n8))
print(ob.numberToWords(n9))